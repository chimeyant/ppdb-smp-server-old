...
Route.group(() => {
  ...
  /**Master route KeluluesanSekolahan */
  Route.resource(
    "master-kelulusan",
    "MasterData/KelulusanController"
  ).middleware(["auth"]);

  Route.post(
    "master-kelulusan-import",
    "MasterData/KelulusanController.import"
  );
  Route.post(
    "master-kelulusan-bulk-delete",
    "MasterData/KelulusanController.bulkdelete"
  );
